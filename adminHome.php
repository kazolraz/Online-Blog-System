...
<h2 align="center" > <?php echo "Welcome "."$name" ?></h2><br>
  ...
  <a align="left" href='logout.php'>Logout</a> 
	...
	while($res = mysql_fetch_array($query)) { 
	    ...
	    echo "<tr rowspan='3'>";
				...
				echo "<td><a href=\"editPadmin.php?id=$res[id]\">Edit</a> | <a href=\"deletePadmin.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
		echo "</tr>";
